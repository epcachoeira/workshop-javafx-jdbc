...
public class SellerFormController implements Initializable {
	...
	private void notifyDataChangeListeners() { // Emissão do evento
	...
	private Seller getFormData() {
		...
		// Instancia a exceção sem lança-la
	...
	public void updateFormData() {
		...
		if (entity.getBirthDate() != null) {
			// Recuperar a data no fuso horário do computador onde p sistema está sendo
			// executado
